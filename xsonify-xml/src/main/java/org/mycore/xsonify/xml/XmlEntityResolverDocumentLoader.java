 ...
 * or XML Schemas.</p>
 */
public class XmlEntityResolverDocumentLoader implements XmlDocumentLoader {
     ...
     */
    public XmlEntityResolverDocumentLoader(EntityResolver entityResolver, XmlParser parser) {
